-- ============================================
-- SCRIPT SQL FINAL - ÉVÉNEMENTS ET NEWSLETTER
-- Exécutez ce script en entier d'un seul coup
-- ============================================

-- ÉTAPE 1 : NETTOYAGE (ignore les erreurs si les tables n'existent pas)
-- ============================================
...
-- ============================================
-- FIN DU SCRIPT - TOUT EST CRÉÉ !
-- ============================================

-- Vérification rapide
SELECT 'Tables créées avec succès!' as status;
SELECT COUNT(*) as nombre_evenements FROM evenements;

-- ============================================
-- SCRIPT SQL CORRIGÉ - ÉVÉNEMENTS ET NEWSLETTER
-- ============================================
...
CREATE TABLE IF NOT EXISTS evenements (
  ...
  title TEXT NOT NULL,
  description TEXT,
  event_date TEXT NOT NULL,  -- Renommé de 'date' à 'event_date' pour éviter les conflits
...
CREATE INDEX IF NOT EXISTS idx_evenements_event_date ON evenements(event_date);
...
INSERT INTO evenements (title, description, event_date, location, time, category, image, price, available_seats, available, featured)
VALUES
  (

// ============================================
// DASHBOARD PARTENAIRE COMPLET - CODE FINAL
// À copier dans : src/Pages/dashboards/PartnerDashboard.tsx
// ============================================
    ...
    <DashboardLayout role="partner">
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={() => toast.info('Formulaire de création de produit à venir')}
        ...
        <div className="bg-white rounded-lg shadow-md">
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px">
              {['overview', 'products', 'bookings', 'earnings', 'profile'].map((tab) => (
                <button
                  key={tab}
                ...
                >
                  ...
                  {tab === 'products' && `Mes Produits (${stats?.total_products || 0})`}
                  {tab === 'bookings' && `Réservations (${stats?.total_bookings || 0})`}
                  {tab === 'earnings' && 'Mes Gains'}
                  {tab === 'profile' && <><Settings className="w-4 h-4 inline mr-2" />Profil</>}
                </button>
              ))}
            </nav>
          </div>
          ...
          <div className="p-6">
            ...
            {activeTab !== 'overview' && (
              <div className="text-center py-12">
                <p className="text-gray-500">Contenu de l'onglet "{activeTab}" à venir</p>
                <p className="text-sm text-gray-400 mt-2">
                  Exécutez d'abord le script SQL DASHBOARD-PARTENAIRE-COMPLET.sql
                </p>
              </div>
            )}
          </div>
